...
class participant():
    ...
    def set_strategy(self, strategy = 'strategy_dealer', count = None):
        '''
        Set the strategy of the participant.
        ...
        if 'True' in list(f.readlines())[-1]: self.set_bet_counting(count)
    ...
    def set_bet_counting(self, count):
        '''
        Set the bet of the player based on counting methods.
        ...
        count: int
            ...
            method.
        '''
        true_count = count / settings.N_DECKS
        bet_value  = max((true_count - 1) * settings.BET_UNIT, 0)
